...
目前資產盤點：35 名角色、11 組正式章節場景、1 張萬界城世界錨點、3 張科幻擴張概念草圖，以及秦罡的 3 格角色分鏡。2026-09-10已完成五張製圖批次（070／085新版，089／097／110新場景），原圖、展示檔與提示詞見[交付記錄](production/batch_2026_09_10/README.md)。下一批製作方向與優先序見 [PRODUCTION_PLAN.md](PRODUCTION_PLAN.md)。

正文目前引用6張正式場景與2張概念圖，並非11組場景都已接入。070／085已改用v2並移至事件段落後；089／097／110已新增。001／068的概念圖與其餘舊圖仍待第零批複核。圖片插入時機、配圖節奏、角色傷勢、手機展示與待開發功能見 [ILLUSTRATION_GUIDE.md](ILLUSTRATION_GUIDE.md)。
